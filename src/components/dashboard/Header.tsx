        ...
        <div className="flex-1 max-w-xl">
          <div className="relative">
            ...
            <Input
              ...
              className="pl-10 pr-4 h-12 border-gray-300 focus:border-you-purple focus:ring-you-purple"
            />
          </div>
        </div>
        
        <div className="flex items-center space-x-4">
          <Button variant="ghost" size="sm" className="text-gray-600 hover:text-you-purple">
            <Filter className="h-4 w-4 mr-2" />
            Filter
          </Button>
          
          <Button variant="ghost" size="sm" className="relative text-gray-600 hover:text-you-purple">
